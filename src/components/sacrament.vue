<template>
    ...
    <div class="h-80 flex flex-col justify-center items-center py-12 px-6 cursor-pointer" :class="{'w-full': selected, 'w-1/4': !selected, 'bg-aux bg-opacity-25': selected == data}" @click="selectOne()">
